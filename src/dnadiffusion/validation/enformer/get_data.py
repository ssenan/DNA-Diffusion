...
# Download data
urllib.request.urlretrieve("https://ftp.ncbi.nlm.nih.gov/pub/clinvar/vcf_GRCh38/clinvar.vcf.gz", f"{DATA_DIR}/clinvar.vcf.gz")

urllib.request.urlretrieve("https://hgdownload.cse.ucsc.edu/goldenpath/hg38/bigZips/hg38.chrom.sizes", f"{DATA_DIR}/hg38.chrom.sizes")
...
urllib.request.urlretrieve("https://fantom.gsc.riken.jp/5/datafiles/reprocessed/hg38_latest/extra/CAGE_peaks/hg38_liftover+new_CAGE_peaks_phase1and2.bed.gz", f"{DATA_DIR}/hg38_liftover+new_CAGE_peaks_phase1and2.bed.gz")
